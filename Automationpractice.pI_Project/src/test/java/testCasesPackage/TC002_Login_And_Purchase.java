...
public class TC002_Login_And_Purchase extends DriverSetup{
	...
	@Description("Test Description: This test will log-in to automationpractice.pl, "
			+ "Then visit to a product from a category and add one product from different category to the cart and complete the checkout process with payment by providing address information. "
